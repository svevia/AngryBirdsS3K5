...
public class ImpactOrder {
     ...
     */
    public static void rebondOiseau(int codeCollision, double multiplicateurVitesse) {
     ...
     * vers le haut, 3 a droite, 4 vers le bas
     */
    public static void rebondObstacle(int codeCollision) {
        switch (codeCollision) {
            case 1:
                bird.setA(bird.getA() - Math.PI);
                break;
